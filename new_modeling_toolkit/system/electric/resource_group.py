...
class ResourceGroup(component.Component):
    ...
    resources: Optional[dict[str, linkage.Linkage]] = None
    flexible_resources: Optional[dict[str, linkage.Linkage]] = None
    hydro_resources: Optional[dict[str, linkage.Linkage]] = None
    shed_dr_resources: Optional[dict[str, linkage.Linkage]] = None
    storage_resources: Optional[dict[str, linkage.Linkage]] = None
    variable_resources: Optional[dict[str, linkage.Linkage]] = None
    hybrid_variable_resources: Optional[dict[str, linkage.Linkage]] = None
    thermal_resources: Optional[Dict[str, linkage.Linkage]] = None
