...
class ThreeWayLinkage(component.Component):
    ...
    def from_dir(
        ...
        for _, name_1, name_2, name_3 in linkage_pairs[["component_1", "component_2", "component_3"]].itertuples():
            if (
                (name_1 in components_dict.get(cls._component_type_1))
                & (name_2 in components_dict.get(cls._component_type_2))
                & (name_3 in components_dict.get(cls._component_type_3))
            ):
                ...
                linkage_inst._instance_1 = instance_1
